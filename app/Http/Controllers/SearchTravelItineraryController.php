...
class SearchTravelItineraryController extends Controller
{
    public function __construct(
        private readonly SearchTravelItineraryAdapterInterface $adapter,
        private readonly SearchTravelItineraryUsecaseInterface $usecase,
    ) {}

    public function __invoke(SearchTravelItineraryRequest $request): JsonResponse
    {
        try {
