...
class TechnicalNotebookGoogleSheetGatewayRepository implements TechnicalNotebookRepositoryInterface
{
    public function __construct(
        private readonly FindAllTechnicalNotebookGoogleSheetRepository $findAllRepository,
        private readonly SearchTechnicalNotebookGoogleSheetRepository $searchRepository,
        private readonly FindTechnicalNotebookByMunicipalityGoogleSheetRepository $findByMunicipalityRepository,
        private readonly FindTechnicalNotebookByProcessGoogleSheetRepository $findByProcessRepository,
        private readonly FindTechnicalNotebookByForceGoogleSheetRepository $findByForceRepository,
        private readonly FindTechnicalNotebookByBuildStatusGoogleSheetRepository $findByBuildStatusRepository,
    ) {}
